...
class Scripts extends Assets {
	...
	function __construct( $base_url, Router $router, Config $config, $default_version = '' ) {
		...
		$this->add( 'wysihtml5', $router->adminUrl( '/core/theme/asset/bootstrap/wysihtml5/js/wysihtml5' . $min . '.js' ), array(), '0.3.0' );
		$this->add( 'jquery', $router->adminUrl( '/core/theme/asset/js/jquery' . $min . '.js' ), array(), '1.10.2' );
		$this->add( 'jquery-ui-widget', $router->adminUrl( '/core/theme/asset/js/jquery.ui.widget' . $min . '.js' ), array( 'jquery' ), '1.10.3' );
		$this->add( 'jquery-iframe-transport', $router->adminUrl( '/core/theme/asset/js/jquery.iframe-transport' . $min . '.js' ), array( 'jquery' ), '1.7' );
		$this->add( 'jquery-fileupload', $router->adminUrl( '/core/theme/asset/js/jquery.fileupload' . $min . '.js' ), array( 'jquery' ), '5.32.2' );
		$this->add( 'bootstrap', $router->adminUrl( '/core/theme/asset/bootstrap/core/js/bootstrap' . $min . '.js' ), array(), '2.3.2' );
		$this->add( 'bootstrap-datepicker', $router->adminUrl( '/core/theme/asset/bootstrap/datepicker/js/bootstrap-datepicker' . $min . '.js' ), array( 'bootstrap' ), '2013-03-12' );
		$this->add( 'bootstrap-wysihtml5', $router->adminUrl( '/core/theme/asset/bootstrap/wysihtml5/js/bootstrap-wysihtml5' . $min . '.js' ), array( 'bootstrap' ), '2013-04-29' );
		$this->add( 'md5', $router->adminUrl( '/core/theme/asset/js/md5' . $min . '.js' ), array() );
	}
