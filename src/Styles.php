...
class Styles extends Assets {
	...
	function __construct( $base_url, Router $router, Config $config, $default_version = '' ) {
        ...
        $this->add( 'bootstrap', $router->adminUrl( '/core/theme/asset/bootstrap/core/css/bootstrap.min.css' ), array(), '2.2.1' );
        $this->add( 'bootstrap-responsive', $router->adminUrl( '/core/theme/asset/bootstrap/core/css/bootstrap-responsive.min.css' ), array( 'bootstrap' ), '2.2.1' );
        $this->add( 'bootstrap-datepicker', $router->adminUrl( '/core/theme/asset/bootstrap/datepicker/css/datepicker.css' ), array( 'bootstrap' ) );
        $this->add( 'bootstrap-wysihtml5', $router->adminUrl( '/core/theme/asset/bootstrap/wysihtml5/css/bootstrap-wysihtml5.css' ), array( 'bootstrap' ) );
        $this->add( 'jquery-fileupload', $router->adminUrl( '/core/theme/asset/css/jquery.fileupload-ui.css' ), array(), '6.10' );
    }
